...
import 'bloc/blocClass.dart';
import 'bloc/blocEvents.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        BlocBuilder<WeatherBloc, blocStates>(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: FlatButton(
                        ...
                        child: Text("Search11", style: TextStyle(color: Colors.white70, fontSize: 16),),
